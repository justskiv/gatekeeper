# access-revocation Specification

## Purpose

Описывает безопасный отзыв доступа при потере подписки, hard-ban и
защитные инварианты, которые не позволяют удалить активного,
неопределённого, внешне добавленного или защищённого участника.
